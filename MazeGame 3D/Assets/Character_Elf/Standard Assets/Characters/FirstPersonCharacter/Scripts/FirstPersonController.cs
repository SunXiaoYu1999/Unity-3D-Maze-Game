...
{ 
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private FOVKick m_FovKick = new FOVKick();     /* 在跑步时增加相机的 fov, 在走路时恢复 */
        [SerializeField] private bool m_UseHeadBob = true;
        [SerializeField] private CurveControlledBob m_HeadBob = new CurveControlledBob();   /* 人物行走时候的左右摆动 */
        ...
        private float m_StepCycle = 0f;     /* 两个变量控制脚步声的播放，每一步播放一次脚步声 */
        private float m_NextStep = 0f;      /* 上同 */
